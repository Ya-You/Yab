...
<div align="center"><h2>图书基本信息</h2></div>
	<form id="addForm" action="upd" method="post">
	<input type="hidden" name="petId" value="${info.bid }"></input>
		<div align="center">
			<table>
				<tr>
					<td align="right">图书名称：</td>
					<td><input type="text" name="petName" id="petName" value="${info.bname }"/></td>
				<tr>
				<tr>
					<td align="right">图书作者：</td>
					<td><input type="text" name="petBreed" id="petBreed" value="${info.bauthor}"/></td>
				<tr>
				<tr>
					<td align="right">购买日期：</td>
					<td><input type="text" name="birthday" id="birthday" value="${info.btime}"/>yyyy-mm-dd</td>
				<tr>
